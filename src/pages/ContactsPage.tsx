...
import { useContacts, useFAQ, useSite } from '../hooks/useContent'
          ...
          <div className="contacts-info-left">
                  ...
                  {contactsData.phones?.map((phone, index) => (
                    <div key={index} className="phone-item">
                      <div className="phone-info">
                        <a href={phone.href} className="contact-link">{phone.number}</a>
                        <a 
            ...
            <div className="contact-item">
              ...
              <div className="contact-info-content">
                ...
                <div className="contact-info-value">
                  <a href={contactsData.email?.href} className="contact-link">{contactsData.email?.text}</a>
                </div>
              </div>
            </div>

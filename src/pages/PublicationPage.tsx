...
const PublicationPage: React.FC = () => {
  ...
  const getTextFromHtml = (html: string) => {
    ...
    tmp.innerHTML = html || ''
    const p = Array.from(tmp.querySelectorAll('p')).find(el => el.textContent && el.textContent.trim().length > 0)
  ...
  return (
    <PageLayout
      ...
      description={getTextFromHtml(post.html) || `Публикация '${post.title}' театра-студии 'Балаганчик' во Владивостоке.`}

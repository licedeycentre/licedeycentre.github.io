        ...
        <div className="footer-content">
            ...
            <div className="footer-block">
              ...
              <div className="footer-socials">
                {contactsData.socials.map((social, index) => {
                  ...
                  return (
                    <a key={index} href={social.href} className="footer-social" target="_blank" rel="noopener noreferrer">
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-legal-links-inline">
              ...
              <span className="footer-photo-info">
                {siteData.footer.photoConsent}
              </span>
            </div>
          </div>
        </div>

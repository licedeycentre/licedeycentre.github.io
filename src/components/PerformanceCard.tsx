...
import { formatShowDateShort, filterFutureShowDates, getLastPastShowDate, formatLastShowDate } from '../utils/dateFormat'
...
export const PerformanceCard: React.FC<PerformanceCardProps> = ({ 
  ...
  return (
    <div className="performance-card">
      ...
      <Link to={`/performances/${generatePerformanceId(performance.title)}`} className="performance-card-bg">
        <MediaThumb 
      ...
      <div className="card-title-area">
        <Link to={`/performances/${generatePerformanceId(performance.title)}`} className="card-title-link">
      ...
      <div className="card-content-area">
        ...
        {showDates && futureDates.length > 0 && (
          <div className="performance-dates">
            ...
            {remainingDates > 0 && (
              <div className="performance-date-more">
                +{remainingDates} ещё
              </div>
            )}
        ...
        {showDates && futureDates.length === 0 && (
          <>
            ...
            {performance.status === 'archived' && performance.showDates && performance.showDates.length > 0 && (() => {
        ...
        {performance.showTicketsButton === true && !(performance.status === 'current' && futureDates.length === 0) && (

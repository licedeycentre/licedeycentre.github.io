...
const NavLink: React.FC<{ to: string; children: React.ReactNode; className?: string }> = ({ to, children, className = '' }) => {
  ...
  return (
    <Link 
      to={to} 
      className={`nav-link ${isActive ? 'is-active' : ''} ${className}`}
    >
      {children}
    </Link>
  )
          ...
          {servicesSubpages.map((page) => {
            ...
            return (
              <li key={page.path} className="mobile-nav-item mobile-nav-item--sub">
                <MobileNavLink to={page.path} onClick={onClose}>{page.label}</MobileNavLink>
              </li>
            )
          })}
        </ul>
        ...
        <div className="header-container">
          ...
          <div className="header-right">
            <div className="header-socials">
              <a className="social-btn" href="https://t.me/licedeycentre" target="_blank" rel="noopener noreferrer" aria-label="Telegram">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d={siTelegram.path} />
                </svg>
              </a>
              <a className="social-btn" href="https://www.tiktok.com/@licedeycentre" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d={siTiktok.path} />
                </svg>
              </a>
              <a className="social-btn" href="https://vk.com/licedeycentre" target="_blank" rel="noopener noreferrer" aria-label="VK">
                <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                  <path d={siVk.path} />
                </svg>
              </a>
          ...
          <nav className="mobile-nav" aria-label="Мобильная навигация">
            <ul className="mobile-nav-list">
              ...
              <li className="mobile-nav-item">
                <MobileNavLink to="/contacts" onClick={() => setIsMobileMenuOpen(false)}>Контакты</MobileNavLink>
              </li>
              <li className="mobile-nav-item">
                <MobileNavLink to="/publications" onClick={() => setIsMobileMenuOpen(false)}>Публикации</MobileNavLink>
              </li>
              <li className="mobile-nav-item">
                <MobileNavLink to="/performances" onClick={() => setIsMobileMenuOpen(false)}>Спектакли</MobileNavLink>
              </li>
            </ul>
          </nav>
        </div>
